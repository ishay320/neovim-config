return {
	...
	opts = {
		vim.keymap.set("n", "<C-/>", "<cmd>ToggleTerm<cr>", { desc = "Terminal horizontal" }),
		vim.keymap.set("t", "<C-/>", "<cmd>ToggleTerm<cr>", { desc = "Terminal horizontal" }),
		vim.keymap.set("n", "", "<cmd>ToggleTerm<cr>", { desc = "Terminal horizontal" }), -- tmux && gnome terminal
		vim.keymap.set("t", "", "<cmd>ToggleTerm<cr>", { desc = "Terminal horizontal" }), -- tmux && gnome terminal
